# Decompiled By EDRIS NABIZADA 
# Github : https://github.com/edrianabizada
#!/usr/bin/python2
#coding=utf-8
...
\033[1;96m -------------------------
\033[1;32m E D R I S N A B I Z A D A
\033[1;96m -------------------------                                                  
\033[1;93m        AUTOMATIC ACCOUNT CRACKER BY \033[1;96mEDRIS NABIZADA
\033[1;97m--------------------------------------------------
\033[1;95m
 AUTHOR     : EDRIS NABIZADA 
 FACEBOOK   : FACEBOOK.COM/EDRIS NABIZADA_____420
 YOUTUBE    : YOUTUBE.COM/Best Hacker 
 GITHUB     : GITHUB.COM/edrianabizada
\033[1;32m
--------------------------------------------------
                                '''
...
def menu():
	...
	jalan("\033[1;92m[22] JOIN OUR BEST HACKER GROUP")
	print
...
def action():
	...
	if bch =='':
	    ...
	    os.system('xdg-open https://youtube.com/channel/UCUuLWMHEyrtIRxAS1HR45uw')
	    time.sleep(1)
  	    menu()
	elif bch =='12':
	    os.system('xdg-open https://youtube.com/channel/UCUuLWMHEyrtIRxAS1HR45uw')
